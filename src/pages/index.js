        ...
        <div className="projects">
          ...
          <div className="project">
            <div className="project-title">
              <a href="https://flask-rpg.com/" target="_blank"><h3>FlaskRPG</h3></a>
            ...
            <div className="project-screenshot">
              <a href="https://flask-rpg.com/" target="_blank"><Img style={{ maxWidth: '600px', margin: '0 auto' }} fluid={data.file2.childImageSharp.fluid} alt="FlaskRPG screenshot" /></a>
          ...
          <div className="project">
            <div className="project-title">
              <a href="https://herobuilds.now.sh/" target="_blank"><h3>HeroBuilds</h3></a>
            ...
            <div className="project-screenshot">
              <a href="https://herobuilds.now.sh/" target="_blank"><Img style={{ maxWidth: '600px', margin: '0 auto' }} fluid={data.file3.childImageSharp.fluid} alt="HeroBuilds screenshot" /></a>
          ...
          <div className="project">
            <div className="project-title">
              <a href="https://github.com/teddyhn/herobuilds-api" target="_blank"><h3>HeroBuilds API</h3></a>
          ...
          <div className="project">
            <div className="project-title">
              <a href="https://github.com/DevDesk-Queue-bw/back-end" target="_blank"><h3>DevDesk Queue Back End</h3></a>
              <GithubButton href={"https://github.com/DevDesk-Queue-bw/back-end"} data-size="large">Source</GithubButton>
            </div>
            <p>A robust help desk ticket system. Built using Node.js with Express. Uses PostgreSQL as the RDMS and Knex as the query builder. Deployed via Heroku.</p>
            <ul className="project-features">
              <h4>Features:</h4>
